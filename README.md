...
2. [hosting](https://github.com/playproject-io/hosting)
    ...
    * [datdot](https://github.com/playproject-io/datdot)
3. [smartcontract.codes](https://github.com/playproject-io/smartcontract.codes)
    ...
    * [wallet](https://github.com/playproject-io/wallet)
...
1. [ ] **`v0.0.1-alpha`** release @ `2019.10.01`
    ...
    * [ ] [`datdot#1` datdot concept & updates](https://github.com/playproject-io/datdot/issues/1)
